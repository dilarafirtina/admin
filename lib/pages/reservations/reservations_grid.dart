...
Widget reservationGrid(BuildContext context, List data) {
  RxBool _sortHotelAsc = true.obs;
  RxBool _sortNameAsc = true.obs;
  RxBool _sortUserAsc = true.obs;
  ...
  RxBool _sortAmountAsc = true.obs;
                  ...
                  () => DataTable(
                    ...
                    columns: <DataColumn>[
                      DataColumn(
                          ...
                          onSort: (columnIndex, sortAscending) {
                            ...
                            data.sort(
                                (a, b) => a.guestName.compareTo(b.guestName));
                            if (!_sortAsc.value) {
                      ...
                      DataColumn(
                          ...
                          onSort: (columnIndex, sortAscending) {
                            if (columnIndex == _sortColumnIndex.value) {
                              _sortAsc.value =
                                  _sortUserAsc.value = sortAscending;
                            } else {
                              _sortColumnIndex.value = columnIndex;
                              _sortAsc = _sortUserAsc;
                            }
                            data.sort(
                                (a, b) => a.recordUser.compareTo(b.recordUser));
                            if (!_sortAsc.value) {
                              data = data.reversed.toList();
                            }
                          }),
                      ...
                      DataColumn(
                          ...
                          onSort: (columnIndex, sortAscending) {
                            if (columnIndex == _sortColumnIndex.value) {
                              _sortAsc.value =
                                  _sortVoucherAsc.value = sortAscending;
                            } else {
                              _sortColumnIndex.value = columnIndex;
                      ...
                      DataColumn(
                          ...
                          onSort: (columnIndex, sortAscending) {
                            if (columnIndex == _sortColumnIndex.value) {
                              _sortAsc.value =
                                  _sortAmountAsc.value = sortAscending;
                            } else {
                              _sortColumnIndex.value = columnIndex;
                    ...
                    rows: List<DataRow>.generate(
                      ...
                      (int index) => DataRow(
                        ...
                        cells: <DataCell>[
                          DataCell(Text(data[index].guestName +
                              " " +
                              data[index].guestSurname)),
