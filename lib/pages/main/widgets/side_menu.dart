...
import 'package:admin/pages/graphs/graphs_view.dart';
              ...
              Column(
                ...
                children: [
                  ...
                  DrawerListTile(
                    ...
                    selected: _tabx.controller.index == 0 ? true : false,
                    press: () {
                      Get.to(MainScreen(child: GraphsView()),
                          preventDuplicates: false);
                    },
                  ),
                  ExpansionTile(
                    ...
                    children: <Widget>[
                      DrawerListTile(
                        ...
                        press: () {
                          Get.to(
                              MainScreen(
                                  child: reservationGrid(context, preConfirmed,
                                      "Ön Onaylı Rezervasyonlar")),
                              preventDuplicates: false);
                        },
                      ),
                      DrawerListTile(
